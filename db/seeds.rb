...
leagues = [
            ["league 1", true, 2, "description", "http://img14.deviantart.net/b672/i/2015/224/b/7/eagle_logo_by_zeldagirninja-d4xp6kp.png", 2, "league 1"],
...
fixtures.each do |fixtures_group_id, fixture_id|
  a = Unirest.get("http://api.football-data.org/v1/fixtures/#{fixture_id}", headers:{"X-Auth-Token" => "4f853811a401439a826aab12321bf6c7"}).body
